...
// Refactored: Paul Aidukas KN2R (Copyright) July 15, 2013
// For ham radio use only, NOT for comercial use!

$BACKGROUND="/supermon/${BACKGROUND}";
if (! empty($MY_TILE)) {
    $MY_TILE="/supermon/${MY_TILE}";
}
if (! empty($MY_TILE2)) {
    $MY_TILE2="/supermon/${MY_TILE2}";
}
...
<div id="headerImg"><a href="https://www.allstarlink.org" target="_blank"><img src="allstarlink.jpg" alt="Allstar Logo"></a></div>
<?php if (! empty($MY_TILE)) { ?>
   <div id="mytilepic"><img src=<?php echo $MY_TILE;?> style="border: 0px;"></div>
<?php } ?>
<?php if (! empty($MY_TILE2)) { ?>
   <div id="mytilepic2"><img src=<?php echo $MY_TILE2;?> style="border: 0px;"></div>
<?php } ?>
</div>
<br>
<div id="cpMain">
